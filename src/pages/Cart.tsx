        ...
        <main className="p-8 max-w-4xl mx-auto">
            ...
            {items.length === 0 ? (
                <div className="bg-white p-8 rounded-lg text-center border border-gray-200">
                    ...
                    <Link
                        to="/"
                        className="inline-block px-6 py-3 bg-blue-600 text-white no-underline rounded hover:bg-blue-700 transition-colors"
                    >
                        Continue Shopping
                    </Link>
                </div>
                ...
                <div>
                    ...
                    <div className="bg-white p-8 rounded-lg border border-gray-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div>
                        ...
                        <Link
                            to="/"
                            className="px-6 py-3 bg-blue-600 text-white no-underline rounded hover:bg-blue-700 transition-colors"
                        >
                            Continue Shopping
                        </Link>
                    </div>
